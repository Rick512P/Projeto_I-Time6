...
void imprimeSimulador(int tamLinhas, type_instruc **instrucoesDecodificadas, instrucao *memoriaInst){
    for(int i=0;i<tamLinhas;i++){
            ...
            else if ((strcmp((*instrucoesDecodificadas)[i].opcode, "0100") == 0) || (strcmp((*instrucoesDecodificadas)[i].opcode, "1011") == 0) || (strcmp((*instrucoesDecodificadas)[i].opcode, "1111") == 0) || (strcmp((*instrucoesDecodificadas)[i].opcode, "0110") == 0)) {
                printf("\n\n=======TIPO I=========\n");
                printf("opcode[%s]\t", (*instrucoesDecodificadas)[i].opcode);
                printf("rs[%s]\t\t", (*instrucoesDecodificadas)[i].rs);
                printf("rt[%s]\t\t", (*instrucoesDecodificadas)[i].rt);
            ...
            else if (strcmp((*instrucoesDecodificadas)[i].opcode, "0010") == 0 || strcmp((*instrucoesDecodificadas)[i].opcode, "1000") == 0){
                printf("\n========TIPO J========\n");
                printf("opcode[%s]\t", (*instrucoesDecodificadas)[i].opcode);
